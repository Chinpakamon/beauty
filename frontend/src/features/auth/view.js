...
export const renderAuthPage = (state) => `
  <section class="auth-landing" aria-labelledby="auth-title">
    <div class="auth-copy">
      ...
      <p class="auth-copy__description">
        Войдите в аккаунт или зарегистрируйтесь через форму, чтобы перейти в
        личный кабинет, управлять профилем и продолжить работу с сервисами
        платформы.
    </div>
